            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="informeCurso.php" class="nav-link">
                                <i class="fas fa-table nav-icon text-warning"></i>
                                <p>Informe por cursos</p>
                            </a>

                        </li>
                        <li class="nav-item">
                            <a href="informeAtleta.php" class="nav-link">
                                <i class="far fa-address-card nav-icon text-success"></i>
                                <p>Informe atletas</p>
                            </a>
                        </li>
                    </ul>
